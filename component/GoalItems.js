...
function GoalItems(props){
    return (
        // IMPORTANT : The this object is going to select the current list item from the complete list. So that this function is called with only the id of the list item that is being pressed.
